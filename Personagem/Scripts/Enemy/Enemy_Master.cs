...
public class Enemy_Master : MonoBehaviour
{
    ...
    public event HealthEventHandler EventEnemyDeductionHealth;
    ...
    public void CallEventEnemyDeductionHealth(int health)
    {
        if(EventEnemyDeductionHealth != null)
        {
            EventEnemyDeductionHealth(health);
        }
    }
